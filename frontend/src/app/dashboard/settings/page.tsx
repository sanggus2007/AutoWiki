...
export default function SettingsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto w-full font-sans text-gray-900 dark:text-gray-100 bg-white dark:bg-[#121212] min-h-full transition-colors">
            ...
            {activeTab === "model" && (
              ...
              >
                <h2 className="text-xl font-bold border-b border-[#a2a9b1] dark:border-zinc-800 pb-2 mb-5 flex items-center text-gray-900 dark:text-white">
                  <Bot className="mr-2 text-[#54595d] dark:text-gray-400" size={20} />
                  LLM 모델 구성
                </h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      >
                        ...
                        <div className="text-[10px] text-[#54595d] dark:text-gray-400 text-center">유료 구독 연동 (추천)</div>
                      </div>
                      ...
                      >
                        ...
                        <div className="text-[10px] text-[#54595d] dark:text-gray-400 text-center">자체 호스팅 & Cloud API</div>
                      </div>
                    </div>
                  </div>
                  ...
                  {aiProvider === "github_copilot" && (
                    <div className="bg-[#f0f7ff] dark:bg-zinc-950 border border-[#0645ad]/20 dark:border-zinc-800 rounded-md p-5 mb-2 shadow-sm animate-in fade-in duration-300">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                          ...
                          className="text-[11px] font-bold text-[#0645ad] dark:text-zinc-300 flex items-center gap-1 hover:underline bg-white dark:bg-zinc-800 px-2 py-1 rounded border border-[#0645ad]/10 dark:border-zinc-700"
                        >
                      ...
                      <div className="space-y-4">
                        {isGithubLinked ? (
                          <div className="flex items-center justify-between bg-white dark:bg-zinc-900 border border-[#00af89]/30 dark:border-emerald-800/30 rounded-lg p-3 shadow-sm gap-2">
                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-xs font-bold text-[#00af89] dark:text-emerald-400">GitHub 계정과 연결됨</div>
                                <div className="text-[10px] sm:text-[11px] text-[#54595d] dark:text-gray-400 font-medium">
                          ...
                          <div className="bg-white dark:bg-zinc-800 border border-[#0645ad]/20 dark:border-blue-900/30 rounded-xl p-6 text-center animate-in fade-in duration-300">
                            {deviceInfo ? (
                              <div className="space-y-5">
                                ...
                                <div className="space-y-3">
                                  ...
                                  <div className="flex items-center justify-center gap-2 text-[12px] text-[#64748b] dark:text-gray-400 font-medium">
                              ...
                              <div className="py-8 flex flex-col items-center gap-3">
                                <Loader2 size={30} className="animate-spin text-[#0645ad] dark:text-zinc-300" />
                                <p className="text-sm font-bold text-[#64748b] dark:text-gray-400">인증 정보를 가져오는 중...</p>
                              </div>
                            )}
                          </div>
                        ) : (
                      ...
                      <div className="mt-4 flex items-center gap-2 text-[11px] text-[#0645ad]/70 dark:text-zinc-300/80 font-medium bg-white/50 dark:bg-zinc-900/50 p-2 rounded-md">
                  ...
                  {aiProvider === "ollama" && (
                    <div className="bg-[#fcf8f2] dark:bg-zinc-950 border border-[#d6a45c]/30 dark:border-zinc-800 rounded-md p-5 mb-2 shadow-sm animate-in fade-in duration-300">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button
                          ...
                          className="text-[11px] font-bold text-[#b87014] dark:text-zinc-300 flex items-center gap-1 hover:underline bg-white dark:bg-zinc-800 px-2 py-1 rounded border border-[#d6a45c]/25 dark:border-zinc-700"
                        >
                          <HelpCircle size={12} /> 설정 안내
                        </button>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          <label className="block text-xs font-bold mb-1 text-[#202122] dark:text-gray-300">
                            Ollama Host URL
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-xs font-bold mb-1 text-[#202122] dark:text-gray-305 flex items-center justify-between">
                          ...
                          <div className="relative">
                            <input
                              ...
                              className="w-full bg-white dark:bg-zinc-800 border border-[#a2a9b1] dark:border-zinc-700 text-[#202122] dark:text-white rounded-sm pl-3 pr-10 py-2 cursor-text focus:outline-none focus:border-[#0645ad] dark:focus:border-zinc-500 transition-all font-mono text-[14px] shadow-inner"
                            />
                            {ollamaApiKey && (
                              <button
                                type="button"
                                onClick={() => setShowApiKey(!showApiKey)}
                                className="absolute right-2.5 top-2.5 text-[#54595d] dark:text-gray-400 hover:text-[#202122] dark:hover:text-white"
                              >
                                {showApiKey ? (
                          ...
                          <p className="text-[10px] text-[#54595d] dark:text-gray-400 mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-[#54595d] dark:text-gray-400 text-xs mb-2">원하는 AI 모델의 식별자를 정확히 입력해 주세요.</p>
                    <input
                      type="text"
                      value={model}
                      onChange={(e) => {
                  ...
                  <div>
                    <label className="block text-sm font-bold mb-1">
                      보조 AI 모델 <span className="font-normal text-[#54595d] dark:text-gray-400 text-xs">(지식 구조 추출용)</span>
                    </label>
                    <p className="text-[#54595d] dark:text-gray-400 text-xs mb-2">1단계 지식 구조 추출에 사용할 모델입니다. 비교적 가벼운 작업이므로 저비용 모델 사용을 권장합니다.</p>
                    <input
                      id="sub-model-input"
                      type="text"
                      value={subModel}
                  ...
                  <div className="grid grid-cols-2 gap-4 p-4 bg-[#eaecf0] dark:bg-zinc-900 border border-[#a2a9b1] dark:border-zinc-800 rounded-sm">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-white dark:bg-zinc-800 border border-[#a2a9b1] dark:border-zinc-700 text-[#202122] dark:text-white rounded-sm px-2 py-1.5 focus:outline-none focus:border-zinc-500 dark:focus:border-zinc-500 text-[16px] sm:text-sm"
                      >
                    ...
                    <div>
                      <label className="block text-xs font-bold mb-1">
                        Reasoning Effort <span className="font-normal text-[#54595d] dark:text-gray-400">(OpenAI o1/o3)</span>
                      </label>
                      <select
                  ...
                  <div className="mt-4 bg-[#eaecf0] dark:bg-zinc-900 border border-[#a2a9b1] dark:border-zinc-800 p-3 rounded-sm flex items-start text-[12px] text-[#202122] dark:text-gray-300">
                    <AlertCircle size={16} className="mr-2 shrink-0 mt-0.5 text-[#0645ad] dark:text-zinc-300" />
                    <p>
                  ...
                  <div className="pt-4 border-t border-[#a2a9b1] dark:border-zinc-700 flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="bg-white dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700 text-[#54595d] dark:text-gray-300 border border-[#a2a9b1] dark:border-zinc-700 font-bold px-3 py-2 rounded-sm flex items-center transition-colors text-sm"
                        title="기본 설정으로 되돌리기"
                      >
                      ...
                      <button
                        onClick={handleSave}
                        className="bg-[#0645ad] dark:bg-zinc-800 hover:bg-[#0b0080] dark:hover:bg-zinc-700 dark:border dark:border-zinc-700 text-white font-bold px-4 py-2 rounded-sm flex items-center transition-colors"
                      >
                    ...
                    {prompts.map((prompt) => (
                      <div key={prompt.key}>
                        ...
                        <textarea
                          ...
                          className="w-full bg-white dark:bg-zinc-950 border border-[#a2a9b1] dark:border-zinc-800 text-[#202122] dark:text-zinc-200 rounded-sm px-3 py-2 cursor-text focus:outline-none focus:border-[#0645ad] dark:focus:border-zinc-500 transition-all font-mono text-[16px] sm:text-[13px] shadow-inner h-64 resize-y"
                          spellCheck="false"
                        />
                      </div>
                    ))}
                    ...
                    <div className="pt-4 border-t border-[#a2a9b1] dark:border-zinc-700 flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="bg-white dark:bg-zinc-800 hover:bg-gray-100 dark:hover:bg-zinc-700 text-[#54595d] dark:text-zinc-300 border border-[#a2a9b1] dark:border-zinc-700 font-bold px-3 py-2 rounded-sm flex items-center transition-colors text-sm"
                          title="권장 프롬프트로 복구"
                        >
                          <RotateCcw size={14} className="mr-1.5" /> 기본값 복구
                        </button>
                    ...
                    {mounted ? (
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        >
                          ...
                          <div className="text-sm font-bold text-gray-900 dark:text-white">라이트 모드</div>
                        </div>
                        ...
                        >
                          ...
                          <div className="text-sm font-bold text-gray-900 dark:text-white">다크 모드</div>
                        </div>
                        ...
                        >
                          ...
                          <div className="text-sm font-bold text-gray-900 dark:text-white">시스템 설정</div>
                        </div>
                      </div>
                    ) : (
